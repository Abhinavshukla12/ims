$(document).ready(function() {
    ...
    var columns = [
        { label: 'Stock ID', name: 'id', width: 90, key: true, cellattr: function () { return 'style="background-color: #FFDDC1"'; } },
        { label: 'Name', name: 'name', width: 150, editable: true, cellattr: function () { return 'style="background-color: #FFECB3"'; } },
        { label: 'Description', name: 'description', width: 200, editable: true, cellattr: function () { return 'style="background-color: #D1C4E9"'; } },
